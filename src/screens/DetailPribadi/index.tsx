      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View className="px-5 py-3">
          ...
          <View className="flex-row items-center">
            ...
            <View className="border-[1px] border-primary rounded-md w-[160] px-2 py-2">
              <DefaultText title={`${detailNasabah?.kota?.kota}, ${detailNasabah?.kota?.provinsi}`} />
            </View>
          </View>
          <Gap height={5} />
          <View className="flex-row items-center">
            ...
            <View className="border-[1px] border-primary rounded-md w-[160] px-2 py-2">
              <DefaultText title={`${detailNasabah?.kota_domisili?.kota}, ${detailNasabah?.kota_domisili?.provinsi}`} />
            </View>
          </View>
          <Gap height={5} />
          <View className="flex-row items-center">
