...
export default function DetailPribadiEdit({ route }: RootStackScreenProps<'DetailPribadiEdit'>) {
  ...
  const [image_ktp_ahli_waris, setImage_ktp_ahli_waris] = useState<string | Asset>(detailPribadi?.image_ktp_ahli_waris ? `${SYARIAH_URL}/${detailPribadi?.image_ktp_ahli_waris}` : '') as any;
